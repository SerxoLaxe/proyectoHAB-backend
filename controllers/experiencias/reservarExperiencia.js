...
/**
 * Comprueba si quedan plazas disponibles teniendo en cuenta las plazas_totales
 * de la experiencia y el número de reservas que hay registradas de esta en la
 * tabla reservas.
 *
 * @param {Object} conexion - Conexion a pool de mysql
 * @param {[number]} param1 - ID del usuario e ID de la experiencia
